(function() {
	...
	BattleshipAI.prototype.normalizePredictions = function() {
		...
		for (x = 0; x < 10; x++) {
			for (y = 0; y < 10; y++) {
				// add 50% protection against AI's that have more uniform or unique distributions of ships
				this.predictionBoard[x][y] *= (1+inverseDistribution[x][y])/2;
	...
	// an approximate inverse of the average distribution of ships randomly placed on a battleship board
	var inverseDistribution = [
		[1.4188, 1.2666, 1.1366, 1.0590, 1.0152, 1.0152, 1.0590, 1.1366, 1.2666, 1.4188],
		[1.2681, 1.1375, 1.0246, 0.9567, 0.9215, 0.9215, 0.9567, 1.0246, 1.1375, 1.2681],
		[1.1351, 1.0232, 0.9238, 0.8636, 0.8334, 0.8334, 0.8636, 0.9238, 1.0232, 1.1351],
		[1.0587, 0.9594, 0.8666, 0.8152, 0.7840, 0.7840, 0.8152, 0.8666, 0.9594, 1.0587],
		[1.0163, 0.9233, 0.8351, 0.7847, 0.7533, 0.7533, 0.7847, 0.8351, 0.9233, 1.0163],
		[1.0163, 0.9233, 0.8351, 0.7847, 0.7533, 0.7533, 0.7847, 0.8351, 0.9233, 1.0163],
		[1.0587, 0.9594, 0.8666, 0.8152, 0.7840, 0.7840, 0.8152, 0.8666, 0.9594, 1.0587],
		[1.1351, 1.0232, 0.9238, 0.8636, 0.8334, 0.8334, 0.8636, 0.9238, 1.0232, 1.1351],
		[1.2681, 1.1375, 1.0246, 0.9567, 0.9215, 0.9215, 0.9567, 1.0246, 1.1375, 1.2681],
